...
begin
  ...
  if p_product_id is not null then
    -- Lock the product row before checking availability so two concurrent
    -- sales of the same product can't both pass the check before either
    -- commits (the status flip to 'sold' only happens after this insert).
